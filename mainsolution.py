...
def mainSolution():
    ...
    """
    # File path for summary_report.txt file
    ...
    summary_file.touch()
    # Create "cohindex" to represent the index postion of the items in the output of cash_on_hand.cash_on_hand()
    cohindex = 0
    # Create "plindex" to represent the index position of the items in the output of profit_loss.profit_loss()
    plindex = 0
    ...
    with summary_file.open(mode = "a", encoding = "UTF-8") as file:
        ...
        while cohindex < len(cash_on_hand.cash_on_hand()):
            ...
            cohindex += 1
        # Create a while loops to repeat appending summary statement into summary_report.txt file for plindex lesser than the number of items in the output of profit_loss.profit_loss()
